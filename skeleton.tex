...
Abstract notions of nondeterminism state that is is modelled by an abstract algebraic structure known as a join semi-lattice \cite{kiselyov2021extensible} which is governed by the following algebraic properties:
